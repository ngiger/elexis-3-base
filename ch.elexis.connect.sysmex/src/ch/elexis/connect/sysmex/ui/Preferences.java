...
public class Preferences extends PreferencePage implements IWorkbenchPreferencePage {
	...
	public Preferences(){
		super(Messages.SysmexAction_ButtonName); //$NON-NLS-1$
	...
	protected Control createContents(final Composite parent){
		...
		new Label(mainComp, SWT.NONE).setText(Messages.Preferences_Modell); //$NON-NLS-1$
		...
		lblRdw.setText(Messages.Preferences_RDW); //$NON-NLS-1$
		...
		new Label(mainComp, SWT.NONE).setText(Messages.Preferences_Backgroundprocess); //$NON-NLS-1$
		...
		new Label(mainComp, SWT.NONE).setText(Messages.Preferences_Log); //$NON-NLS-1$
		...
		connectGroup.setText(Messages.Preferences_Verbindung); //$NON-NLS-1$
		...
		ports.setText(CoreHub.localCfg.get(PORT, Messages.SysmexAction_DefaultPort)); //$NON-NLS-1$
		...
		String timeoutStr =
			CoreHub.localCfg.get(TIMEOUT, Messages.SysmexAction_DefaultTimeout); //$NON-NLS-1$
