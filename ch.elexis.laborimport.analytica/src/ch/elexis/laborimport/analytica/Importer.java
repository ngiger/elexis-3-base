...
public class Importer extends ImporterPage {
	...
	private Result<?> importDirectFtp(){
		Result<String> result =
			new Result<>(ch.elexis.laborimport.analytica.Messages.Importer_ok); //$NON-NLS-1$
	...
	private class LabImporter extends Composite {
		...
		public LabImporter(final Composite parent, final ImporterPage home){
			...
			bFile.setText(ch.elexis.laborimport.analytica.Messages.Importer_label_importFile);
			...
			bDirect.setText(ch.elexis.laborimport.analytica.Messages.Importer_label_importDirect +
