...
public class PreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
	...
	protected void createFieldEditors(){
		...
		final RadioGroupFieldEditor groupFieldEditor =
			new RadioGroupFieldEditor(
				...
				Messages.PreferencePage_direktimport_label, 2, new String[][] { //$NON-NLS-1$
					{
						Messages.PreferencePage_batchscript_label, BATCH}, { Messages.PreferencePage_ftpserver_label, FTP}},
				parentComp, true);
		...
		addField(new StringFieldEditor(FTP_HOST,
			Messages.PreferencePage_label_host, getFieldEditorParent()));
		addField(new StringFieldEditor(FTP_USER,
			Messages.PreferencePage_label_user, getFieldEditorParent()));
		addField(new StringFieldEditor(FTP_PWD,
			Messages.PreferencePage_label_password, getFieldEditorParent()));
		addField(new InexistingDirectoryOKDirectoryFieldEditor(DL_DIR,
			Messages.PreferencePage_label_download, getFieldEditorParent()));
	}
