...
public abstract class MediPortAbstractPrefPage extends PreferencePage implements
	...
	public static final String LBL_NEW_KEY = Messages.MediPortAbstractPrefPage_lbl_Neu; // production/test //$NON-NLS-1$

	public static final String LBL_DOC_NO_PRINT =
		Messages.MediPortAbstractPrefPage_lbl_Nein; //$NON-NLS-1$
	public static final String LBL_DOC_PRINT_COPY =
		Messages.MediPortAbstractPrefPage_lbl_Ja; //$NON-NLS-1$
	...
	public static final String LBL_DIST_TYPE_B =
		Messages.MediPortAbstractPrefPage_lbl_BPost; //$NON-NLS-1$
	public static final String LBL_DIST_TYPE_A =
		Messages.MediPortAbstractPrefPage_lbl_APost; //$NON-NLS-1$

	public static final String LBL_LANGUAGE_D =
		Messages.MediPortAbstractPrefPage_lbl_Deutsch; //$NON-NLS-1$
	public static final String LBL_LANGUAGE_F =
		Messages.MediPortAbstractPrefPage_lbl_Franzoesisch; //$NON-NLS-1$
	public static final String LBL_LANGUAGE_I =
		Messages.MediPortAbstractPrefPage_lbl_Italienisch; //$NON-NLS-1$
	...
	public static final String LBL_SERVER_URL_PRODUKTIV =
		VALUE_SERVER_URL_PRODUKTIV
			+ ":" + Messages.MediPortAbstractPrefPage_lbl_ProduktivServer; //$NON-NLS-1$ //$NON-NLS-2$
	public static final String LBL_SERVER_URL_TEST =
		VALUE_SERVER_URL_TEST + ":" + Messages.MediPortAbstractPrefPage_lbl_TestServer; //$NON-NLS-1$ //$NON-NLS-2$
