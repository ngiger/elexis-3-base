...
public class ShowErrorInvoices extends Dialog {
	...
	protected void configureShell(Shell newShell){
		...
		newShell.setText(Messages.ShowErrorInvoices_title_Antworten);
	}
	...
	public Control createDialogArea(final Composite parent){
		...
		txtInformation.setText(Messages.ShowErrorInvoices_msg_Rechnungsantworten +
			Messages.ShowErrorInvoices_msg2_Rechnungsantworten);
